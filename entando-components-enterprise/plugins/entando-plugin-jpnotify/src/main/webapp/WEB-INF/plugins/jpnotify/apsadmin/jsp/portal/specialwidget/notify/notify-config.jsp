...
<s:form action="saveConfig" namespace="/do/jpnotify/Notify/Page/SpecialWidget/jpnotifyNotifyConfig" cssClass="form-horizontal">
		...
		<div class="form-group margin-base-top">
			<div class="col-xs-12">
				...
				<div class="input-group">
					<wpsf:select cssClass="form-control" list="notifysId" name="id" id="id" cssClass="form-control" />
