...
<div id="main">
    ...
    <p class="sr-only">
			...
			<wpsf:hidden name="campaignId" />
			<wpsf:hidden name="profileId" />
		</p>
                                ...
                                <s:iterator value="recipientsBcc" var="recipient" >
                                    <span class="label label-default label-sm pull-left padding-small-top padding-small-bottom margin-small-right margin-small-bottom">
                                        ...
                                        <wpsa:actionParam action="removeAddress" var="actionName" >
                                            ...
                                            <!-- NEW -->
                                            <wpsa:actionSubParam name="pageCode" value="%{#pageCode}"/>
																						<wpsa:actionSubParam name="frame" value="%{#frame}" />
																						<wpsa:actionSubParam name="widgetTypeCode" value="%{#widgetTypeCode}" />
																						<wpsa:actionSubParam name="campaignId" value="%{#campaignId}" />
																						<wpsa:actionSubParam name="profileId" value="%{#profileId}" />
