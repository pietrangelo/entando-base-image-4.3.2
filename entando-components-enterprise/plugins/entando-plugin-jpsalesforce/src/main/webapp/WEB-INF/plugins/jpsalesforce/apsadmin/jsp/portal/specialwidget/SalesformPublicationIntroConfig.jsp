...
<div id="main">
    ...
    <div class="subsection-light">
        ...
        <s:form action="chooseCampaign" namespace="/do/jpsalesforce/Page/SpecialWidget/publication" cssClass="form-horizontal">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            ...
                            <label for="jpwebdynamicform_typecode"><s:text name="jpsalesforce.label.typeCode"/></label>
                    ...
                    <%--
				            <div class="form-group">
											<div class="col-xs-12">
												<label for="jpsalesforce-config-campaign"><s:text name="label.salesforce.campaign"/></label>
