...
/*
 * Kettle engine comes with an a log4j.xml file that overrides the existing one
 * see: http://jira.pentaho.com/browse/PDI-1791
 * If the Entando default logger, async, is not found causes a NullPointerException in startup.
 */
