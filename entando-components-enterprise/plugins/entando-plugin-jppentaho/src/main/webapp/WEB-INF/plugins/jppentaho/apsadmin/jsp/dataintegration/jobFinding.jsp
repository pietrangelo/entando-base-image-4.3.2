...
<h1><s:text name="jppentaho.title.dataIntegration.jobManagement" /></h1>
...
<s:set var="processes" value="jobs" />
<s:if test="#processes==null || #processes.size()==0" >
	<s:text name="jppentaho.note.job.list.none"/>
</s:if>
<s:else>

	<s:text name="jppentaho.title.job.list.caption"/>
	...
	<a href="<s:url action="edit">
		...
		<s:param name="transformation" value="false" />
