...
<s:form action="saveConfig" namespace="/do/jppentaho5/Page/SpecialWidget/displayReportConf" cssClass="form-horizontal">
...
<!-- 	</div> -->
	...
	<div class="form-group">
		<div class="col-xs-12">
			<s:text name="jppentaho.controller.cssClassParam" /><br/>
			<s:textfield name="cssClassParam" /> 
		</div>
	</div>
