      ...
      <tr> 
        ...
        <td> <s:set var="mailVar" value="%{#itemVar.getEmailAddresses()}"/>
            <s:iterator value="#mailVar" var="addresses" >
                  <s:set value="%{#addresses.getEmailAddress()}" var="addressValueVar"/>
                          <s:if test="#addressValueVar.length()>15">
                            <abbr title="<s:property  value="%{#addressValueVar}"/>"><s:property  value="%{#addressValueVar.substring(0,14)}"/>..</abbr>
                            </s:if>
                            <s:else><s:property  value="%{#addressValueVar}"/></s:else>
            </s:iterator>
        </td>
