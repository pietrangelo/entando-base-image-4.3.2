...
</br><s:if test="_messageErrors!=null"><div class="alert alert-error"><s:property value="_messageErrors"/></div></s:if></br>
<form action="<wp:action path="/ExtStr2/do/FrontEnd/Ctct/saveEvent.action"/>" method="post" >
    <div class="form ">
        <div class="form-group ">
        <label class=control-label" for="Event_Name">*&nbspEvent Name &nbsp<abbr title="Name must be univocal">?</abbr></label>
            <div class="controls ">
                <wpsf:textfield id="Event_Name" name="_eventName" value="" required="required" />
            </div>
        </div>  
        <div class="form-group">
            <label class="control-label" for="Event_Title" >*&nbspEvent Title</label>
             <div class="controls">
                <wpsf:textfield id="Event_Title" name="_eventTitle" value="" required="required" />
            </div>
        </div>
        <div class="form-group">
            <label class="control-label" for="Event_Title" >*&nbspCreator</label>
             <div class="controls">
                <wpsf:textfield id="User_Name" name="_userName" value="" required="required" />
            </div>
        </div>
        ...
        <div class="form-group">
            <label class="control-label" for="Event_Title" >*&nbspOrganization Name</label>
             <div class="controls">
                <wpsf:textfield id="Organization_Name" name="_organizationName" value="" required="required" />
            </div>
        </div>    
 
        <div class="form-group">
            <label class="control-label"  for="Start_Day"  >*&nbspStart Date (UTC):</label>
             <div class="controls controls-row">
                <wpsf:textfield id="Start_Day" name="_eventStartDate" value=""  cssClass="input-small" placeholder="yyyy-MM-dd" required="required"/>
                     HH
        ...
        <div class="form-group">
            <label class="control-label"  for="End_Day" >*&nbspEnd Date (UTC):</label>
            <div class="controls controls-row  ">
                <wpsf:textfield id="End_Day" cssClass="input-small" name="_eventEndDate" value="" placeholder="yyyy-MM-dd" required="required"/>
        ...
        <div class="form-group">
            ...
            <div class="controls">
                <wpsf:textfield id="Event_Location" name="_eventLocation" value="" />
            </div>
        </div> 
        <div class="form-group">
            <label class="control-label"  for="Event_TimeZone" >*&nbspTimezone</label> 
