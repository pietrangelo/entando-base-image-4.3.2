...
public class RemoteThreadChangingEvent extends ApsRemoteEvent {


	@Override
	public String getEventID() {
		return JpForumRemoteNotifierSystemConstants.CONFIG_CHANGING_REMOTE_EVENT_ID;
	}

	@Override
	public void notify(IManager srv) {
		((RemoteThreadChangingObserver) srv).updateFromThreadChanging(this);
	}

	@Override
	public Class getObserverInterface() {
		return RemoteThreadChangingObserver.class;
	}
