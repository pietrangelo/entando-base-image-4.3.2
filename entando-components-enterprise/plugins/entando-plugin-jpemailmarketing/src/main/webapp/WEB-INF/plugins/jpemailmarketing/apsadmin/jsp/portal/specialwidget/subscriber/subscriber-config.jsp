...
<s:form action="saveConfig" namespace="/do/jpemailmarketing/Subscriber/Page/SpecialWidget/jpemailmarketingSubscriberConfig" cssClass="form-horizontal">
		...
		<div class="form-group margin-base-top">
			<div class="col-xs-12">
				...
				<div class="input-group">
					<wpsf:select cssClass="form-control" list="subscribersId" name="id" id="id" cssClass="form-control" />
