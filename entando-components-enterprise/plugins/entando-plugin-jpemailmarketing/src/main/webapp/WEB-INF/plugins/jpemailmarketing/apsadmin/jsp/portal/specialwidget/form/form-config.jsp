...
<s:form action="saveConfig" namespace="/do/jpemailmarketing/Form/Page/SpecialWidget/jpemailmarketingFormConfig" cssClass="form-horizontal">
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		<div class="form-group margin-base-top">
			<div class="col-xs-12">
				<label for="<s:property value="courseId" />"><s:text name="label.courseId" /></label>
				<div class="input-group">
					<wpsf:select list="formsId" name="courseId" id="courseId" listKey="key" listValue="value" cssClass="form-control" />
