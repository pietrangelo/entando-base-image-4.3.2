...
<s:form action="saveConfig" namespace="/do/jpemailmarketing/Course/Page/SpecialWidget/jpemailmarketingCourseConfig" cssClass="form-horizontal">
		...
		<div class="form-group margin-base-top">
			<div class="col-xs-12">
				...
				<div class="input-group">
					<wpsf:select cssClass="form-control" list="coursesId" name="id" id="id" cssClass="form-control" />
