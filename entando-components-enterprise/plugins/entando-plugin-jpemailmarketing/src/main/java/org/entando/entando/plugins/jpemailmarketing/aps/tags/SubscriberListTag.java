...
public class SubscriberListTag extends TagSupport {

	private static final Logger _logger =  LoggerFactory.getLogger(SubscriberListTag.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			*/
			List<Integer> list = subscriberManager.getSubscribers();
			this.pageContext.setAttribute(this.getVar(), list);
		} catch (Throwable t) {
			_logger.error("Error in doStartTag", t);
			throw new JspException("Error in SubscriberListTag doStartTag", t);
		}
