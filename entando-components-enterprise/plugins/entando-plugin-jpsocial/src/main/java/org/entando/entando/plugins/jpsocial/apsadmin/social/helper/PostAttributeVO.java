...
public class PostAttributeVO {
   ...
   * @param attributeName
   * @param lang
   * @param unique when true prevents further references to the same attribute in the queue
   */
  public PostAttributeVO(String queue, String attributeName, String lang, boolean unique) {
    this._queue = queue;
