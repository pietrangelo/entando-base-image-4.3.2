...
<div id="main">
    ...
    <div class="subsection-light">
        ...
        <s:form action="saveConfig" namespace="/do/jpjasper/Page/SpecialWidget/EmbeddedConfigViewerConfig">
            <p class="noscreen">
                    ...
                    <fieldset class="col-xs-12">
                        ...
                        <div class="form-group">
                            <label for="jasperTheme">
                                ...
                                <wpsf:select cssClass="form-control" name="jasperTheme" 
                                             id="jasperTheme" list="folders" listKey="name" listValue="label" 
                                             value="jasperTheme"></wpsf:select>
                            </div>
                            <div class="form-group">
