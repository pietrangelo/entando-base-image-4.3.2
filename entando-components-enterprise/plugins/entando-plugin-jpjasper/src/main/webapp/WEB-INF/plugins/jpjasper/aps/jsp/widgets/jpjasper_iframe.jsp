...
<c:catch var="clientException">
	<scwp:iframe var="jasperRedirectUrlVar"  jasperaction = "1" />
</c:catch>
...
<c:choose>
	<c:when test="${null != jasperRedirectUrlVar}">
		<iframe src="<c:out value="${jasperRedirectUrlVar}" escapeXml="true"/>" width="100%" height="<wp:currentWidget param="config" configParam="height" />">
