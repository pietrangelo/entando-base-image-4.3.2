...
<div id="main">
	...
	<s:set value="dashboards" var="dashboardsList" />
	<s:if test="null == #dashboardsList">
		<div class="alert alert-info">
			<p>
				<s:text name="jpjasper.note.noDashboards" />
			</p>
			<p>
				<s:url action="configure" namespace="/do/Page" var="configureAction">
					<s:param name="selectedNode" value="pageCode" />
				</s:url>
				<a href="<s:property value="#configureAction" />"><s:text name="label.back"/></a>
			</p>			
		</div>
	</s:if>
	<s:else>
        <s:form action="saveConfig" namespace="/do/jpjasper/Page/SpecialWidget/EmbeddedDashboardViewerConfig">
            <p class="noscreen">
                ...
                <div class="panel-body">
                    ...
                    <fieldset class="col-xs-12">
                        ...
                        <div class="form-group">
                            <label for="dashboardResource">
                                <s:text name="label.dashboardResource" /></label>
                                <wpsf:select cssClass="form-control" name="dashboardResource" id="dashboardResource" list="#dashboardsList" listKey="uriString" listValue="uriString+ ' (' +label+ ')'" ></wpsf:select>
                            </div>
                            <div class="form-group">
