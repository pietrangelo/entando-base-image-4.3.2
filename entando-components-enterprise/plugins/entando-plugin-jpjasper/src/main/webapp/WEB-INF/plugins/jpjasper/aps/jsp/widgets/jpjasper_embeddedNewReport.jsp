...
<c:catch var="clientException">
	<scwp:iframeEmbedded  var="jasperRedirectUrlVar" heightVarName="embeddedNewReport_height" />
</c:catch>
...
<c:choose>
	<c:when test="${null != jasperRedirectUrlVar}">
		<iframe src="<c:out value="${jasperRedirectUrlVar}" escapeXml="true"/>" width="100%" height="<c:out value="${embeddedNewReport_height}" />">
