...
<link rel="stylesheet" type="text/css" href="<wp:resourceURL />/plugins/jpjasper/administration/css/administration.css" media="screen" />
...
<!--//--><![CDATA[//><!--
	window.addEvent("domready", function() {
		var calendars = document.getElements(".report-input-control-item input[id$=_cal]");
		if (calendars != null) {
			var calendarOpts = {
				navigation: 1,
			...
			for (var i = 0;i<calendars.length;i++) {
				var istanceSetup = {};
				istanceSetup[calendars[i].get("id")] = "Y-m-d";
