...
public class RemotePageModelChangingEvent extends ApsRemoteEvent {
	
	@Override
	public String getEventID() {
		return JpRemoteNotifierSystemConstants.PAGEMODEL_CHANGING_REMOTE_EVENT_ID;
	}
	
	@Override
	public void notify(IManager srv) {
		((RemotePageModelChangingObserver) srv).updateFromPageModelChanging(this);
	}
	
	@Override
	public Class getObserverInterface() {
		return RemotePageModelChangingObserver.class;
	}
