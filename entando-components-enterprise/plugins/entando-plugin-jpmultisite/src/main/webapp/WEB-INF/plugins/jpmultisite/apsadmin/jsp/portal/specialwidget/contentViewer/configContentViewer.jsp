...
<h1 class="panel panel-default title-page">
	<span class="panel-body display-block">
		<a href="<s:url action="viewTree" namespace="/do/jpmultisite/Page" />" title="<s:text name="note.goToSomewhere" />: <s:text name="title.pageManagement" />">
			<s:text name="title.pageManagement" /></a>&#32;/&#32;
		<a href="
						<s:url action="configure" namespace="/do/jpmultisite/Page">
...
<s:action namespace="/do/jpmultisite/Page" name="printPageDetails" executeResult="true" ignoreContextParams="true"><s:param name="selectedNode" value="pageCode"></s:param></s:action>

<s:form action="saveViewerConfig" namespace="/do/jpmultisite/Page/SpecialWidget/Viewer" cssClass="form-horizontal">
					...
					<div class="col-xs-12">
						...
						<p class="form-control-static">
							...
							<s:if test="#canEditCurrentContent">
								<a href="<s:url action="edit" namespace="/do/jpmultisite/Content"><s:param name="contentId" value="#content.id" /></s:url>" title="<s:text name="label.edit" />:&#32;<s:property value="#content.descr"/>"><s:property value="#content.descr"/></a>
							</s:if>
							<s:else>
