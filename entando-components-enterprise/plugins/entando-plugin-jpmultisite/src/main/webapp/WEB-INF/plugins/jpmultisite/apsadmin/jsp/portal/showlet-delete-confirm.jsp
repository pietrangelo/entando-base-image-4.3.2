...
<s:form namespace="/do/jpmultisite/Portal/WidgetType" action="delete">
	<p class="sr-only">
	...
	<div class="alert alert-warning">
		...
		<a class="btn btn-link" href="<s:url action="viewWidgets" namespace="/do/jpmultisite/Portal/WidgetType"/>" ><s:text name="note.goToSomewhere" />: <s:text name="title.widgetManagement" /></a>
		</div>
	</div>
</s:form>
</div>