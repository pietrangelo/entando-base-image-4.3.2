...
<s:form action="saveConfig" namespace="/do/jpmultisite/Multisite/Page/SpecialWidget/jpmultisiteMultisiteConfig">
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<s:select cssClass="form-control" list="multisitesId" name="code" />
			</div>
		</div>
