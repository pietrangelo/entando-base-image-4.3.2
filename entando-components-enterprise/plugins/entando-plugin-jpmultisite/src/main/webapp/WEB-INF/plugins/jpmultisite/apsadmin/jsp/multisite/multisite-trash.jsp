...
<h1 class="panel panel-default title-page">
	<span class="panel-body display-block">
		...
		<s:if test="getStrutsAction() == 4">
			<s:text name="jpmultisite.multisite.label.delete" />
		</s:if>
	</span>
</h1>
	...
	<s:form action="delete" cssClass="form-horizontal">
		...
		<div class="alert alert-warning">
			<p>
				<s:text name="note.deleteMultisite.areYouSure" />&#32;
			...
			<div class="text-center margin-large-top">
				...
				<a class="btn btn-link" href="<s:url action="list"/>" ><s:text name="note.goToSomewhere" />: <s:text name="jpmultisite.title.multisiteManagement" /></a>
			</div>
		</div>
