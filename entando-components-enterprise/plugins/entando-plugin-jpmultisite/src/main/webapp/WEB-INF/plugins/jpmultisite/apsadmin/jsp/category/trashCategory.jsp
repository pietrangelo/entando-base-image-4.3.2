	...
	<s:form action="delete">
		...
		<div class="alert alert-warning">
			...
			<div class="text-center margin-large-top">
				...
				<a class="btn btn-link"	href="<s:url action="viewTree" namespace="/do/jpmultisite/Category"><s:param name="selectedNode"><s:property value="%{#categoryToDelete.code}" /></s:param></s:url>">
