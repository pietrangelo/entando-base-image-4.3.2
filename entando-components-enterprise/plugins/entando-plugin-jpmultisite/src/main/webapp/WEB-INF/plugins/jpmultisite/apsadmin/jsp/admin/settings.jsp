...
<div class="row settings-row">
	...
	<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 margin-large-bottom">
			<a href="<s:url namespace="/do/jpmultisite/BaseAdmin" action="configSystemParams" />" class="btn btn-default btn-lg btn-block">
	...
	<wp:ifauthorized permission="superuser">
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 margin-large-bottom">
			<a href="<s:url action="list" namespace="/do/jpmultisite/User" />" class="btn btn-default btn-lg btn-block">
	...
	<%--
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 margin-large-bottom">
			<a href="<s:url action="list" namespace="/do/jpmultiste/Role" />" class="btn btn-default btn-lg btn-block">
	...
	<wp:ifauthorized permission="superuser">
		...
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 margin-large-bottom">
			<a href="<s:url namespace="/do/LicenseKey" action="intro" />" class="btn btn-default btn-lg btn-block">
					<span class="icon fa fa-star"></span>&#32;
					<s:text name="menu.settings.license" />
			</a>
			<small class="text-muted display-block margin-base-bottom">
				<s:text name="menu.settings.license.keywords" />
			</small>
		</div>
		<%--
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 margin-large-bottom">
