...
<h1 class="panel panel-default title-page">
	<span class="panel-body display-block">
		<a href="<s:url action="viewWidgets" namespace="/do/jpmultisite/Portal/WidgetType" />" title="<s:text name="note.goToSomewhere" />: <s:text name="title.widgetManagement" />">
		...
		<s:if test="%{isUserAllowed(#singlePage)}">
			<div class="col-sm-3 col-lg-3">
				<div class="btn-group pull-right">
					<a href="
							<s:url namespace="/do/jpmultisite/Page" action="viewTree">
					...
					<a href="
							<s:url namespace="/do/jpmultisite/Page" action="configure">
			...
			<div class="row">
				<div class="col-sm-3 col-lg-3">
					<div class="btn-group pull-right">
						<div class="btn-group">
							...
							<ul class="dropdown-menu">
								<s:if test="null != #showlet.type.typeParameters && #showlet.type.typeParameters.size() > 0">
									<li>
										<a href="<s:url namespace="/do/jpmultisite/Portal/WidgetType" action="copy"><s:param name="pageCode" value="#singlePage.code" /><s:param name="framePos" value="#rowstatus.index" /></s:url>">
						...
						<a href="<s:url action="editFrame" namespace="/do/jpmultisite/Page">
				...
				<div class="col-sm-1">
					<a href="<s:url action="trashWidgetFromPage" namespace="/do/jpmultisite/Portal/WidgetType">
								<s:param name="pageCode"><s:property value="#singlePage.code"/></s:param>
								<s:param name="frame"><s:property value="#rowstatus.index"/></s:param>
