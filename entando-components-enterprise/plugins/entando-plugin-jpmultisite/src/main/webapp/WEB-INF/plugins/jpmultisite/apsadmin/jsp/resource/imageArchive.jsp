...
<div class="row">
	...
	<s:iterator var="resourceid" status="status">
		...
		<s:url var="URLedit" action="edit" namespace="/do/jpmultisite/Resource">
			<s:param name="resourceId" value="%{#resourceid}" />
		</s:url>
		<s:url var="URLuse" action="joinResource" namespace="/do/jpmultisite/Content/Resource">
			<s:param name="resourceId" value="%{#resourceid}" />
			<s:param name="contentOnSessionMarker" value="contentOnSessionMarker" />
		</s:url>

		<s:url var="URLtrash" action="trash" namespace="/do/jpmultisite/Resource">
			<s:param name="resourceId" value="%{#resourceid}" />
		...
		<div class="col-sm-4 col-md-3">
			...
			<s:if test="!onEditContent">
				...
				<s:set var="fileInfo">
					<s:include value="/WEB-INF/plugins/jacms/apsadmin/jsp/resource/imageArchive-file-info.jsp" />
				</s:set>
...
<s:if test="!onEditContent">
<s:action name="openAdminProspect" namespace="/do/jpmultisite/Resource/Admin" ignoreContextParams="true" executeResult="true">
