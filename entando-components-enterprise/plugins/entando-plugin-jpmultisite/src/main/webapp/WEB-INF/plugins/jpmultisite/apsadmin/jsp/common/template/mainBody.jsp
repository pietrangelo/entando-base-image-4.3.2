...
<div id="main" role="main">
	...
	<jpmultisite-apsadmin:activityStream var="activityStreamListVar" />
	<s:if test="null != #activityStreamListVar && #activityStreamListVar.size() != 0">
		...
		<ul class="list-unstyled padding-large-top" id="activity-stream">
			<s:include value="/WEB-INF/plugins/jpmultisite/apsadmin/jsp/common/activity-stream/inc/stream.jsp" />
		</ul>
		<div class="row">
