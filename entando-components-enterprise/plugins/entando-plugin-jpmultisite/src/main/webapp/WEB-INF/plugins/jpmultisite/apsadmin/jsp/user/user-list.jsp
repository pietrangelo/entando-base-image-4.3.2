...
<h1 class="panel panel-default title-page">
	<span class="panel-body display-block">
		<a href="<s:url namespace="/do/jpmultisite/BaseAdmin" action="settings" />"><s:text name="menu.configure" /></a>
		&#32;/&#32;
...
<s:form action="search" cssClass="form-horizontal" role="search">
	...
	<a href="<s:url namespace="/do/jpmultisite/User" action="new" />" class="btn btn-default">
		...
		<div class="table-responsive">
			<table class="table table-bordered">
				...
				<s:iterator var="usernameVar">
					...
					<s:url action="edit" namespace="/do/jpmultisite/User/Authorization" var="editUserAuthActionVar"><s:param name="username" value="#usernameVar"/></s:url>
					<s:url action="edit" namespace="/do/jpmultisite/userprofile" var="editUserProfileActionVar"><s:param name="username" value="#usernameVar"/></s:url>
					<s:url action="view" namespace="/do/jpmultisite/userprofile" var="viewUserProfileActionVar"><s:param name="username" value="#usernameVar"/></s:url>
