...
<h1 class="panel panel-default title-page">
	<span class="panel-body display-block">
		<a href="<s:url action="list" namespace="/do/jpmultisite/Content"/>"><s:text name="jacms.menu.contentAdmin" /></a>
		&#32;/&#32;
...
<p class="sr-only">
	...
	<div class="alert alert-warning">
		...
		<a class="btn btn-link" href="<s:url action="list" namespace="/do/jpmultisite/Content"/>" ><s:text name="note.goToSomewhere" />: <s:text name="title.contentList" /></a>
		</div>
	</div>
</s:form>