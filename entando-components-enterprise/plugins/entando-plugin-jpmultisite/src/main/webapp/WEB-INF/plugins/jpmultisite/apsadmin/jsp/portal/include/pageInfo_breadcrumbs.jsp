...
<%--	<s:if test="%{#rowstatus.index != 0}">&#32;/&#32;</s:if> --%>
	...
	<s:else>
		<a href="<s:url namespace="/do/jpmultisite/Page" action="viewTree" ><s:param name="selectedNode"><s:property value="#target.code" /></s:param></s:url>" title="<s:text name="note.goToSomewhere" />: <s:property value="getTitle(#target.code, #target.titles)" />">
