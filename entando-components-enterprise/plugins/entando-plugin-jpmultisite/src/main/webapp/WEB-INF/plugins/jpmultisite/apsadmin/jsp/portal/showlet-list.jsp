	...
	<div class="row">
		...
		<div class="col-sm-8 col-lg-8">
			...
			<div class="col-xs-10 col-md-11">
				<a href="<s:url namespace="/do/jpmultisite/Portal/WidgetType" action="edit"><s:param name="widgetTypeCode" value="#showletType.key" /></s:url>" title="<s:text name="label.configWidget" />: <s:property value="#showletType.value" />" ><span class="icon fa fa-cog"></span>
				<s:property value="#showletType.value" /> - <s:property value="#showletType.key" /></a>
		...
		<s:if test="#showletUtilizers != null && #showletUtilizers.size() > 0">
			<a href="<s:url namespace="/do/jpmultisite/Portal/WidgetType" action="viewWidgetUtilizers"><s:param name="widgetTypeCode" value="#showletType.key" /></s:url>" title="<s:text name="title.widgetManagement.howmanypages.goToSee" />: <s:property value="#showletType.value" />" class="btn btn-default"><span class="icon fa fa-info"></span></a>
		</s:if>
		...
		<s:set var="concreteShowletTypeVar" value="%{getShowletType(#showletType.key)}"></s:set>
			...
			<s:if test="null != #concreteShowletTypeVar.typeParameters && #concreteShowletTypeVar.typeParameters.size() > 0">
				<a href="<s:url namespace="/do/jpmultisite/Portal/WidgetType" action="new"><s:param name="parentShowletTypeCode" value="#showletType.key" /></s:url>" title="<s:text name="label.userWidget.new.from" />: <s:property value="#showletType.value" />" class="btn btn-default"><span class="icon fa fa-puzzle-piece"></span></a>
			</s:if>
			<s:if test="#firstType.optgroup == 'userShowletCode' && !#concreteShowletTypeVar.isLocked() && (#showletUtilizers == null || #showletUtilizers.size() == 0)">
				<a href="<s:url namespace="/do/jpmultisite/Portal/WidgetType" action="trash"><s:param name="widgetTypeCode" value="#showletType.key" /></s:url>" title="<s:text name="label.remove" />: <s:property value="#showletType.value" />" class="btn btn-warning" ><span class="icon fa fa-times-circle-o"></span></a>
			</s:if>
			</wp:ifauthorized>
