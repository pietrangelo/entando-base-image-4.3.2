							...
							<tr>
								...
								<td>
									<s:if test="#isAuthToEditVar">
										<a href="<s:url action="edit" namespace="/do/jpmultisite/Content"><s:param name="contentId" value="#currentContentVar.id" /></s:url>" title="<s:text name="label.edit" />:&#32;<s:property value="#currentContentVar.descr"/>"><s:property value="#currentContentVar.descr"/></a>
									</s:if>
