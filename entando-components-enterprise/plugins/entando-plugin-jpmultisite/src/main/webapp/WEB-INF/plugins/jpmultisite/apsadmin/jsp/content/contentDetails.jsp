								...
								<s:iterator var="curReferencedContentId" value="#referencedContentsIdVar">
									<dd>
										...
										<s:if test="#isAuthToEditVar">
											<s:url var="contentEditActionURL" action="edit" namespace="/do/jpmultisite/Content"><s:param name="contentId" value="#curReferencedContent.id" /></s:url>
						...
						<dl id="jpcontentinspection_referring_conts">
							...
							<s:if test="!#referencingContentsIdVar.empty">
								<s:iterator var="curReferencingContentId" value="#referencingContentsIdVar">
									...
									<dd>
										<s:if test="#isAuthToEditVar">
											<s:url var="contentEditActionURL" action="edit" namespace="/do/jpmultisite/Content"><s:param name="contentId" value="#curReferencingContent.id" /></s:url>
