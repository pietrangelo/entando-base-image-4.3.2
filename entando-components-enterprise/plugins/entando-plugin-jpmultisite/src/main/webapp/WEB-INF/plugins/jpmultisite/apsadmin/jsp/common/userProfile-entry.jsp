...
<s:form namespace="/do/jpmultisite/CurrentUser" action="changePassword" cssClass="form-horizontal">
...
<s:action name="edit" namespace="/do/jpmultisite/currentuser/profile" executeResult="true"></s:action>
