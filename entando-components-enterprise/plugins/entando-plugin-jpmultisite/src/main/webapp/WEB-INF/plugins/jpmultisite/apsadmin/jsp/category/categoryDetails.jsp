...
<h1 class="panel panel-default title-page">
	<span class="panel-body display-block">
		<a href="<s:url action="viewTree" namespace="/do/jpmultisite/Category" />" 
...
<div id="main" role="main">
	...
	<s:include value="/WEB-INF/plugins/jpmultisite/apsadmin/jsp/category/include/categoryInfo_breadcrumbs.jsp" />
	...
	<s:include value="/WEB-INF/plugins/jpmultisite/apsadmin/jsp/category/include/categoryInfo-references.jsp" />
</div>