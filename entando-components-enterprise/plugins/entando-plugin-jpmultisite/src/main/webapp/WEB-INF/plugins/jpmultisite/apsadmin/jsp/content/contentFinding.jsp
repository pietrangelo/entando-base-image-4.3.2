...
<s:set var="targetNS" value="%{'/do/jpmultisite/Content'}" />
...
<div id="main" role="main">
		...
		<s:url action="search" var= "formAction" namespace="do/jpmultisite/Content" />
				...
				<div class="input-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<div id="search-advanced" class="collapse well collapse-input-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<s:action name="showCategoryTreeOnContentFinding" namespace="/do/jpmultisite/Content" ignoreContextParams="true" executeResult="true"></s:action>
							</div>
						</div>
						<div class="form-group">
		...
		<div class="btn-group">
		  ...
		  <ul class="dropdown-menu" role="menu">
			<s:iterator var="contentTypeVar" value="#contentTypesVar">
				<li><a href="<s:url action="createNew" namespace="/do/jpmultisite/Content" >
		...
		<div class="table-responsive">
			...
			<td class="text-center text-nowrap">
				<div class="btn-group btn-group-xs">
					<a class="btn btn-default" title="<s:text name="label.edit" />: <s:property value="#content.id" /> - <s:property value="#content.descr" />" href="<s:url action="edit" namespace="/do/jpmultisite/Content"><s:param name="contentId" value="#content.id" /></s:url>">
					...
					<ul class="dropdown-menu text-left" role="menu">
						<li>
							<a title="<s:text name="label.copyPaste" />: <s:property value="#content.id" /> - <s:property value="#content.descr" />" href="<s:url action="copyPaste" namespace="/do/jpmultisite/Content"><s:param name="contentId" value="#content.id" /><s:param name="copyPublicVersion" value="'false'" /></s:url>">
						...
						<li>
							<a title="<s:text name="label.inspect" />: [<s:text name="name.work" />] <s:property value="#content.id" /> - <s:property value="#content.descr" />" href="<s:url action="inspect" namespace="/do/jpmultisite/Content"><s:param name="contentId" value="#content.id" /><s:param name="currentPublicVersion" value="'false'" /></s:url>">
								<span class="icon fa fa-fw icon-info"></span>
								<s:text name="label.inspect" />&#32;<s:text name="name.work" />
							</a>
						</li>
						<li>
							<a title="<s:text name="label.inspect" />: [<s:text name="name.onLine" />] <s:property value="#content.id" /> - <s:property value="#content.descr" />" href="<s:url action="inspect" namespace="/do/jpmultisite/Content"><s:param name="contentId" value="#content.id" /><s:param name="currentPublicVersion" value="'true'" /></s:url>">
								<span class="icon fa fa-fw icon-info"></span>
