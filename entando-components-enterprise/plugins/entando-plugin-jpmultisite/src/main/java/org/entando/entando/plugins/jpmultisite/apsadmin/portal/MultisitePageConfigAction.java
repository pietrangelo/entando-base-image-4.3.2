 ...
 * @author S.Loru
 */
public class MultisitePageConfigAction extends PageConfigAction {
	
	private static final Logger _logger = LoggerFactory.getLogger(MultisitePageConfigAction.class);
