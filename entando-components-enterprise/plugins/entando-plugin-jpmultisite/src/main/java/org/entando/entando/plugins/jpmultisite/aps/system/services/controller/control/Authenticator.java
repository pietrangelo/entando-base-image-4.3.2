...
public class Authenticator extends AbstractControlService {
    ...
    public int service(RequestContext reqCtx, int status) {
        ...
        try {
			...
			// start customization for multisite plugin
			username = username + getSessionParamMultisiteCode(req);
			// end customization for multisite plugin
	...
	private String getSessionParamMultisiteCode(HttpServletRequest req){
		String sessionParamMultisiteCode = MultisiteUtils.getMultisiteCodeSuffix(req);
		if(StringUtils.isNotBlank(sessionParamMultisiteCode)){
			sessionParamMultisiteCode = JpmultisiteSystemConstants.MULTISITE_SUFFIX_SEPARATOR + sessionParamMultisiteCode;
		}
		return sessionParamMultisiteCode;
	}
