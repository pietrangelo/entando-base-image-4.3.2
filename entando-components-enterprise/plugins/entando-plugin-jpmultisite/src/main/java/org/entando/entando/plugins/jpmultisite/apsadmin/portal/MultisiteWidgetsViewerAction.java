 ...
 * @author S.Loru
 */
public class MultisiteWidgetsViewerAction extends WidgetsViewerAction {
	
	private static final Logger _logger = LoggerFactory.getLogger(MultisiteWidgetsViewerAction.class);
